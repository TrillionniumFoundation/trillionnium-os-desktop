...
_impl.REQUIRED_PATHS = [
    ...
    "tests/test_event_loop_completion.py",
    "tools/audit_event_loop_completion.py",
    "crates/hepta-browser-actor/src/engine_dispatch/event_loop.rs",
    "crates/hepta-browser-actor/src/engine_dispatch/event_loop_tests.rs",
    "crates/hepta-browser-actor/src/engine_dispatch/event_loop_transport_tests.rs",
    *_impl.REQUIRED_PATHS,
    ...
    "crates/hepta-session-core/tests/journal_chain_reopen.rs",
    "crates/hepta-session-core/tests/journal_chain_process_recovery.rs",
    "crates/hepta-session-core/tests/support/journal_chain_fixture.rs",
    "crates/hepta-d3-development/src/sessiond/storage_tests.rs",
    "docs/architecture/D3_JOURNAL_CHAIN_RECOVERY.md",
    ...
    "tools/documentation_claims.py",
    "tests/test_documentation_claim_projection.py",
    "tests/d5/test_trusted_app_origin_conformance.py",
    "contracts/golden/trusted-app-origins.v1.tsv",
    "contracts/capability-permit.v2.schema.json",
    "tests/d6/test_capability_boundary_hardening.py",
    "docs/adr/0006-d6-versioned-permit-and-transaction-boundary.md",
    "apps/hepta-browserd/tests/trusted_app_origins.rs",
    "crates/hepta-browser-contracts/tests/trusted_app_origins.rs",
    "docs/architecture/DOCUMENTATION_CLAIM_PROJECTIONS.md",
    "docs/adr/0005-d5-publisher-qualified-origin-alignment.md",
    ".github/README.md",
    "contracts/README.md",
    "docs/README.md",
    "experiments/d3-semantic-resolver-rust/README.md",
    "experiments/servo-embedder-probe/README.md",
    "experiments/servo-headed-runtime/README.md",
    "manifests/README.md",
