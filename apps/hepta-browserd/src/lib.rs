...
//! codec, AgentPort, and session self-check only: it does not start Servo,
//! bind a listener, dispatch a BrowserActor, or perform an external network
//! operation.
...
mod tests {
    ...
    fn self_check_exercises_transport_codec_agent_port_and_session_core() {
        ...
        assert_eq!(report.implementation_stage, "D0R_D0C04_SOURCE");
    }
}
