...
1. Read `manifests/project-state.v1.json`, `manifests/gates.v1.json`,
   `manifests/modules.v1.json`, the active plan, and applicable ADR/security
...
4. Update implementation, schemas/contracts, golden vectors, Rust types, tests,
   machine truth, module documentation, and claim ceilings together.
