...
EXPECTED_LOCK_SHA256 = "32b8f956ae34a9a05feb4f10d600eb0a25e6790b904b58d62e9eff11ffa10664"
...
class CommittedD1LockBindingTests(unittest.TestCase):
    def test_selection_is_bound_to_exact_committed_signed_lock(self) -> None:
        ...
        for inrelease in lock["inrelease"]:
            self.assertRegex(
                inrelease["effective_url"],
                r"^https://snapshot\.debian\.org/file/[0-9a-f]+/InRelease$",
            )
