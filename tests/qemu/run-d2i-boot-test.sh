...
assert proof["zero_process_intermediate_topology"] is True, proof
assert proof["pre_fault_direct_child"] is True, proof
assert proof["post_termination_active_content_processes"] == 0, proof
assert proof["post_recovery_active_content_processes"] == 1, proof
assert proof["post_recovery_direct_child"] is True, proof
PY
