...
This document defines the source-side bootstrap and the live-setting evidence
required to close D0T-03. It does not itself prove that GitHub settings, human
review identities, release approvers, or signing-key custody exist.
...
After this bootstrap PR is independently reviewed and merged:

1. apply and capture the live GitHub controls;
2. pass the dynamic acceptance corpus;
3. replay D0A-02 and D1 on the governed current `main`;
...
No administrator bypass or historical artifact may be used to manufacture a
closure state.
