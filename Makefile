.PHONY: validate truth module-docs d3-runtime-evidence custody late-stage fmt check-rust clippy test-python test self-check check
...
check: validate truth module-docs d3-runtime-evidence custody late-stage fmt check-rust clippy test self-check
